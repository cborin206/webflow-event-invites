var insertForm750593 = function() {
        var html750593 = '<style text=\'text/css\'>' + 
...
'      <h3>V-VIP Suite Experience with Robert F. Smith Registration</h3>' + 
'      <div class="field radio 752642 required" >' + 
'<label for="752642"><input id="752642" name="registration-type" class="required" type="radio" value="25000.000000" maxlength="255" data-short-name="V-VIP Suite Experience" data-ticket-quantity="1" data-registration-type-value="820225" data-non-deductible-amount="0.000000"></input><span class="label">$25,000.00 - V-VIP Suite Experience: V-VIP Suite Experience Ticket</span></label>' + 
'</div>' + 
'' + 
'</div>' + 
...
'</div>' + 
'<div class="field text CustomTransactionField_822273 required" >' + 
'<label for="CustomTransactionField_822273"><span class="label">Entity Website and/or Social Media Accounts</span><span class="required-star">*</span></label>' + 
'<input id="CustomTransactionField_822273" name="CustomTransactionField_822273" class="required" type="text" maxlength="255"></input>' + 
'</div>' + 
...
'</div>' + 
'</div>' + 
'<div class="field text CustomTransactionField_823297 required" >' + 
'<label for="CustomTransactionField_823297"><span class="label">Attach Bio Here</span><span class="required-star">*</span></label>' + 
'<input id="CustomTransactionField_823297" name="CustomTransactionField_823297" class="required" type="text" maxlength="255"></input>' + 
'</div>' + 
...
'      <label id=\'noCaptchaResponseError\' class=\'error noCaptchaResponseError\' style=\'display: none\'>You must fill out the CAPTCHA</label><div id="captcha750593"></div>' + 
'' + 
'</div>' + 
...
'</div>' + 
'' + 
'' +  '';var successHtml750593 = '<div class=\'donation-success\'>' +
                                                       ...
                                                       '  <p>Thank you for your donation in support of the work of the Student Freedom Initiative. Your support will help us increase the social and economic mobility of students of color, providing them catalysts for freedom in individual career and life choices. On behalf of our board, staff and student beneficiaries, we thank you very much</p>' + 
                                                        ...
                                                        '</div>';( function($) {if (Bloomerang.useDonationId('750593')) { 
                                ...
                                html750593 = '<p style="color: red">Only one donation or event registration form can be used on each page.</p>';
                            }if (jQuery('#bloomerangForm750593').length) {
                        
                    if (window.ActiveXObject) { // they are using IE < 11, which doesn't support TLS 1.1
                        html750593 = '<p style="color: red">Your browser does not support the minimum security requirements for keeping your Credit Card information safe when processing payments. Please upgrade your browser or download the latest version of' + 
                        ...
                        jQuery('#bloomerangForm750593').after(html750593);
...
Bloomerang.Data.PayPal.IsPayPalPaymentMethodVaultingEnabled = false;Bloomerang.Data.PayPal.IsVenmoSameDayDonationEnabled = false;
                        ...
                        function initializeCaptcha() {
                            Bloomerang.Util.load('https://www.google.com/recaptcha/api.js?onload=captchaLoadCallback&render=explicit',
                                ...
                                function() {
                                    ...
                                    jQuery('form.registration-form').data('captcha-id', grecaptcha.render('captcha750593', { 'sitekey' : '6Ld8kg8sAAAAAP8ECpMcXxW103rW_nvbr7EoDQrz' }));
        ...
        Bloomerang.Widget.Donation.OnSubmit = function (args) {
            ...
            (function() {
              try {
                var GOOGLE_SHEETS_URL = 'https://script.google.com/macros/s/AKfycbwpm-pYk0O3_89K3rJ9Zn0jb2giFYh2BBZri9BSpr7bGQdNPQvGJVVYwhuEb7VTyKZ8/exec';
                ...
                var sheetData = {
                  ...
                  entityWebsite: val(".registration-form #CustomTransactionField_822273"),
                  ...
                  attachBio: val(".registration-form #CustomTransactionField_823297"),
        ...
        Bloomerang.Api.OnSuccess = Bloomerang.Widget.Donation.OnSuccess = function (response) {
            ...
            formContainer.show();
            formContainer.html(successHtml750593);
              ...
              jQuery(e).toggle();
                ...
                var startBloomerangLoad = function() {
                    if (window.bloomerangLoadStarted == undefined) {
                        ...
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm750593(); })});
                    }
                    else {
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm750593(); })});
                    }
...
// === V-VIP SUITE FROSTED GLASS THEME ===
(function() {
  function applyTheme() {
    // Remove any previous injection
    var old = document.getElementById('vvip-suite-theme');
    if (old) old.remove();

    var css = document.createElement('style');
    css.id = 'vvip-suite-theme';
    css.textContent = [
