var insertForm1051648 = function() {
        var html1051648 = '<style text=\'text/css\'>' + 
...
'      <h3 style="display:none">Fireside Chat  - Community Partner Registration</h3>' + 
'      <div class="field radio 1052672 required" >' + 
'<label for="1052672"><input id="1052672" name="registration-type" class="required" type="radio" value="325.000000" maxlength="255" data-short-name="Young Professionals (35 and under)" data-ticket-quantity="1" data-registration-type-value="976897" data-non-deductible-amount="0.000000"></input><span class="label">$325.00 - Young Professionals (35 and under)</span></label>' + 
'</div>' + 
'<div class="field radio 1052673 required" >' + 
'<label for="1052673"><input id="1052673" name="registration-type" class="required" type="radio" value="650.000000" maxlength="255" data-short-name="Representatives of Community Partners" data-ticket-quantity="1" data-registration-type-value="1050625" data-non-deductible-amount="0.000000"></input><span class="label">$650.00 - Representatives of Community Partners</span></label>' + 
'</div>' + 
...
'      <label id=\'noCaptchaResponseError\' class=\'error noCaptchaResponseError\' style=\'display: none\'>You must fill out the CAPTCHA</label><div id="captcha1051648"></div>' + 
'' + 
'</div>' + 
...
'</div>' + 
'' + 
'' +  '';var successHtml1051648 = '<div class=\'donation-success\'>' +
                                                       ...
                                                       '  <p>Thank you for your donation in support of the work of the Student Freedom Initiative. Your support will help us increase the social and economic mobility of students of color, providing them catalysts for freedom in individual career and life choices. On behalf of our board, staff and student beneficiaries, we thank you very much</p>' + 
                                                        ...
                                                        '</div>';( function($) {if (Bloomerang.useDonationId('1051648')) { 
                                ...
                                html1051648 = '<p style="color: red">Only one donation or event registration form can be used on each page.</p>';
                            }if (jQuery('#bloomerangForm1051648').length) {
                        
                    if (window.ActiveXObject) { // they are using IE < 11, which doesn't support TLS 1.1
                        html1051648 = '<p style="color: red">Your browser does not support the minimum security requirements for keeping your Credit Card information safe when processing payments. Please upgrade your browser or download the latest version of' + 
                        ...
                        jQuery('#bloomerangForm1051648').after(html1051648);
...
Bloomerang.Data.PayPal.IsPayPalPaymentMethodVaultingEnabled = false;Bloomerang.Data.PayPal.IsVenmoSameDayDonationEnabled = false;
                        ...
                        function initializeCaptcha() {
                            Bloomerang.Util.load('https://www.google.com/recaptcha/api.js?onload=captchaLoadCallback&render=explicit',
                                ...
                                function() {
                                    ...
                                    jQuery('form.registration-form').data('captcha-id', grecaptcha.render('captcha1051648', { 'sitekey' : '6Ld8kg8sAAAAAP8ECpMcXxW103rW_nvbr7EoDQrz' }));
        ...
        Bloomerang.Widget.Donation.OnSubmit = function (args) {
            ...
            (function() {
              try {
                var GOOGLE_SHEETS_URL = 'https://script.google.com/macros/s/AKfycbz6QDuTLJdvrpxHHCUzL3yWZ98lCjSuJ0dQU_VTFWbJJrGG4hQ_HuJd5YYfyzMW73MdVQ/exec';
                ...
                // Helper to get select dropdown text
                ...
                var sheetData = {
                  ...
                  formName: 'Fireside Chat - Community Partner',
                ...
                // Silent fail — don't block Bloomerang submission
        ...
        Bloomerang.Api.OnSuccess = Bloomerang.Widget.Donation.OnSuccess = function (response) {
            ...
            formContainer.show();
            formContainer.html(successHtml1051648);
              ...
              jQuery(e).toggle();
                ...
                var startBloomerangLoad = function() {
                    if (window.bloomerangLoadStarted == undefined) {
                        ...
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm1051648(); })});
                    }
                    else {
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm1051648(); })});
                    }
...
// === FIRESIDE CHAT COMMUNITY PARTNER FROSTED GLASS THEME ===
(function() {
  function applyTheme() {
    // Remove any previous injection
    var old = document.getElementById('fireside-chat-community-theme');
    if (old) old.remove();

    var css = document.createElement('style');
    css.id = 'fireside-chat-community-theme';
    css.textContent = [
