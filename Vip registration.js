var insertForm862208 = function() {
        var html862208 = '<style text=\'text/css\'>' + 
...
'      <label id=\'noCaptchaResponseError\' class=\'error noCaptchaResponseError\' style=\'display: none\'>You must fill out the CAPTCHA</label><div id="captcha862208"></div>' + 
'' + 
'</div>' + 
...
'</div>' + 
'' + 
'' +  '';var successHtml862208 = '<div class=\'donation-success\'>' +
                                                       ...
                                                       '  <p>Your registration for our event has been successfully processed. We look forward to seeing you there!</p>' + 
                                                        ...
                                                        '</div>';( function($) {if (Bloomerang.useDonationId('862208')) { 
                                ...
                                html862208 = '<p style="color: red">Only one donation or event registration form can be used on each page.</p>';
                            }if (jQuery('#bloomerangForm862208').length) {
                        
                    if (window.ActiveXObject) {
                        html862208 = '<p style="color: red">Your browser does not support the minimum security requirements for keeping your Credit Card information safe when processing payments. Please upgrade your browser or download the latest version of' + 
                        ...
                        jQuery('#bloomerangForm862208').after(html862208);
...
Bloomerang.Data.PayPal.IsPayPalPaymentMethodVaultingEnabled = false;Bloomerang.Data.PayPal.IsVenmoSameDayDonationEnabled = false;
                        ...
                        function initializeCaptcha() {
                            Bloomerang.Util.load('https://www.google.com/recaptcha/api.js?onload=captchaLoadCallback&render=explicit',
                                ...
                                function() {
                                    ...
                                    jQuery('form.registration-form').data('captcha-id', grecaptcha.render('captcha862208', { 'sitekey' : '6Ld8kg8sAAAAAP8ECpMcXxW103rW_nvbr7EoDQrz' }));
        ...
        Bloomerang.Api.OnSuccess = Bloomerang.Widget.Donation.OnSuccess = function (response) {
            ...
            formContainer.show();
            formContainer.html(successHtml862208);
        ...
        updateRegistrationAmounts = function() {
          var totalCents = 0;
          var centsForSelectedRegistration = (Number(jQuery(".registrationType input[name='registration-type']:checked").val()) || 0) * 100;
        ...
        jQuery(".registration-form #country").change(function(event) {
          var element = jQuery(event.target || event.srcElement);
          ...
          jQuery(".registration-form #state, .registration-form #province").val("");
          if (element.val() == "BM") {
        ...
        collectPayment = function () {
          ...
          if (!Bloomerang.ValidateEventRegistrationFormCaptcha()) { return false; }
              ...
              jQuery(e).toggle();
                ...
                var startBloomerangLoad = function() {
                    if (window.bloomerangLoadStarted == undefined) {
                        ...
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm862208(); })});
                    }
                    else {
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm862208(); })});
                    }
