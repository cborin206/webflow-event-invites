var insertForm815104 = function() {
        var html815104 = '<style text=\'text/css\'>' + 
...
'<label for="818176"><input id="818176" name="registration-type" class="required" type="radio" value="1000.000000" maxlength="255" data-short-name="Fireside Chat Ticket" data-ticket-quantity="1" data-registration-type-value="814081" data-non-deductible-amount="0.000000"></input><span class="label">$1,000.00 - Fireside Chat Ticket</span></label>' + 
'</div>' + 
...
'</div>' + 
'<div class="field text CustomTransactionField_801793 required" style="display:none">' + 
'<label for="CustomTransactionField_801793">Will you be attending with a guest?<span class="required-star">*</span></label>' + 
'<select id="CustomTransactionField_801793" name="CustomTransactionField_801793" style="display:none"><option value=""></option>' + 
...
'<label class="custom-radio"><input type="radio" name="radio_801793" value="802817"><span>Yes</span></label>' + 
'<label class="custom-radio"><input type="radio" name="radio_801793" value="803841"><span>No</span></label>' + 
'</div>' + 
'</div>' + 
'' + 
'</div>' + 
...
'      <label id=\'noCaptchaResponseError\' class=\'error noCaptchaResponseError\' style=\'display: none\'>You must fill out the CAPTCHA</label><div id="captcha815104"></div>' + 
'' + 
'</div>' + 
...
'</div>' + 
'' + 
'' +  '';var successHtml815104 = '<div class=\'donation-success\'>' +
                                                       ...
                                                       '  <p>Thank you for your donation in support of the work of the Student Freedom Initiative. Your support will help us increase the social and economic mobility of students of color, providing them catalysts for freedom in individual career and life choices. On behalf of our board, staff and student beneficiaries, we thank you very much</p>' + 
                                                        ...
                                                        '</div>';( function($) {if (Bloomerang.useDonationId('815104')) { 
                                ...
                                html815104 = '<p style="color: red">Only one donation or event registration form can be used on each page.</p>';
                            }if (jQuery('#bloomerangForm815104').length) {
                        
                    if (window.ActiveXObject) { // they are using IE < 11, which doesn't support TLS 1.1
                        html815104 = '<p style="color: red">Your browser does not support the minimum security requirements for keeping your Credit Card information safe when processing payments. Please upgrade your browser or download the latest version of' + 
                        ...
                        jQuery('#bloomerangForm815104').after(html815104);
...
Bloomerang.Data.PayPal.IsPayPalPaymentMethodVaultingEnabled = false;Bloomerang.Data.PayPal.IsVenmoSameDayDonationEnabled = false;
                        ...
                        function initializeCaptcha() {
                            Bloomerang.Util.load('https://www.google.com/recaptcha/api.js?onload=captchaLoadCallback&render=explicit',
                                ...
                                function() {
                                    ...
                                    jQuery('form.registration-form').data('captcha-id', grecaptcha.render('captcha815104', { 'sitekey' : '6Ld8kg8sAAAAAP8ECpMcXxW103rW_nvbr7EoDQrz' }));
        ...
        Bloomerang.Api.OnSuccess = Bloomerang.Widget.Donation.OnSuccess = function (response) {
            ...
            formContainer.show();
            formContainer.html(successHtml815104);
              ...
              jQuery(e).toggle();
                ...
                var startBloomerangLoad = function() {
                    if (window.bloomerangLoadStarted == undefined) {
                        ...
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm815104(); })});
                    }
                    else {
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm815104(); })});
                    }
...
// === FIRESIDE CHAT FROSTED GLASS THEME ===
(function() {
  function applyTheme() {
    // Remove any previous injection
    var old = document.getElementById('fireside-chat-theme');
    if (old) old.remove();

    var css = document.createElement('style');
    css.id = 'fireside-chat-theme';
    css.textContent = [
